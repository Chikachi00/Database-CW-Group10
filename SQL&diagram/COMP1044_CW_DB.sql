...
(1, 'admin_main', '$2y$10$EDrJtsTIyjEJKEYkkkwd1.D/OPV49yngrW8UAyIjdcDFH/wT/Tc4G', 'Admin'),
(2, 'Dr_smith', '$2y$10$U5v7DOtKx0Ku4uTDjr/SMeCxOgtOo7.48TlXMytWMkLlA1bcuKUGq', 'Assessor'),
(3, 'Prof_jones', '$2y$10$tpsHpyZQzFQFu2UapetZsOn6wLXqbVAeZjLSz4.f8BI5y/Z63TpHa', 'Assessor');
...
--
ALTER TABLE `Assessments`
  MODIFY `assessment_id` int NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
