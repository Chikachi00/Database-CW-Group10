                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="manage_users.php?delete_id=<?= $row['user_id']; ?>" class="btn-action btn-danger" onclick="event.preventDefault(); showDeleteModal(this.href, 'Are you sure you want to delete this assessor?');">Delete</a>
                            </td>
                        </tr>
                        <?php endforeach; ?>
                    </tbody>
